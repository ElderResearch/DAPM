...
#'
#' @param k The number of neighbors to take into consideration.
#' 
#' @return Returns 0 on success and an integer > 0 if an error occured. These
#'         integer codes should be unique.
#' 
...
function(cycle_date=NULL, prevDays=90, inputDF=NULL, scoreTableName="nrd.enty_score", k=17) {
